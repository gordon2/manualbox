// Build-time tools only. Kept in a separate module so the main module's
// dependency graph stays free of sqlc's database-driver transitive tree.
module github.com/gordon2/manualbox/tools
