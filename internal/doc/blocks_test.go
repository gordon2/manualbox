...
func TestRegionBlocksHeadingThenParagraphs(t *testing.T) {
	...
	got := doc.RegionBlocks(blockPage(23, lines...), wholePage(23))
...
func TestRegionBlocksSplitParagraphsOnAGap(t *testing.T) {
	...
	got := doc.RegionBlocks(blockPage(30, lines...), wholePage(30))
...
func TestRegionBlocksKeepAParagraphWhoseLinesAreOnePitchApart(t *testing.T) {
	got := doc.RegionBlocks(blockPage(31, bodyLines(20, 22, 8, "eine Zeile")...), wholePage(31))
...
func TestRegionBlocksReadAListWithHangingIndents(t *testing.T) {
	...
	got := doc.RegionBlocks(blockPage(24, lines...), wholePage(24))
...
func TestRegionBlocksReadAListNumberedWithoutPunctuation(t *testing.T) {
	...
	got := doc.RegionBlocks(p, &doc.Region{Page: 11, X0: 0, X1: testBlockPageWidth, Lang: "de"})
...
func TestRegionBlocksNeverPromoteAParagraphTail(t *testing.T) {
	...
	got := doc.RegionBlocks(blockPage(4, lines...), wholePage(4))
...
func TestRegionBlocksNeverPromoteAFigureCallout(t *testing.T) {
	...
	got := doc.RegionBlocks(blockPage(11, lines...), wholePage(11))
...
func TestRegionBlocksReadColumnsOneAtATime(t *testing.T) {
	...
	got := doc.RegionBlocks(blockPage(62, lines...), wholePage(62))
...
func TestRegionBlocksReadOnlyInsideTheBox(t *testing.T) {
	...
	got := doc.RegionBlocks(blockPage(2, lines...),
		&doc.Region{Page: 2, X0: 30, X1: 280, Lang: "de"})
...
func TestRegionBlocksEmptyRegion(t *testing.T) {
	...
	if got := doc.RegionBlocks(page, wholePage(3)); len(got) != 0 {
	...
	if got := doc.RegionBlocks(page, &doc.Region{Page: 4, X0: 800, X1: 890}); len(got) != 0 {
...
func TestRegionBlocksIgnoreWhatIsNotText(t *testing.T) {
	...
	clean := doc.RegionBlocks(page, wholePage(9))
	...
	got := doc.RegionBlocks(page, wholePage(9))
...
func TestRegionBlocksJoinRunsAsThePageShowsThem(t *testing.T) {
	...
	got := doc.RegionBlocks(p, wholePage(5))
	if len(got) != 1 {
...
func TestRegionBlocksAreNaturallyKeyed(t *testing.T) {
	...
	first := doc.RegionBlocks(page, region)
	second := doc.RegionBlocks(page, region)
...
func TestRegionsBlocksReadOnlyWhatIsInScope(t *testing.T) {
	...
	got := doc.RegionsBlocks(pages, regions, map[string]bool{"de": true})
	if len(got) == 0 {
	...
	all := doc.RegionsBlocks(pages, regions, nil)
	if len(all) <= len(got) {
